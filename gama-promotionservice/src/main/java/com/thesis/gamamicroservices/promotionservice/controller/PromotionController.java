...
import com.thesis.gamamicroservices.promotionservice.service.*;
...
public class PromotionController {
    ...
    public void deletePromotion(@PathVariable int id) throws NoDataFoundException, ServiceDownException {
    ...
    @ResponseStatus(HttpStatus.OK)
    @PreAuthorize("hasRole('ADMIN')")
    public void addProductsToPromotion(@PathVariable int promotion_id, @RequestBody ProductReferenceSetDTO productReferenceSetDTO) throws NoDataFoundException, PromotionConflictException, ServiceDownException {
    ...
    @ResponseStatus(HttpStatus.OK)
    @PreAuthorize("hasRole('ADMIN')")
    public void removeProductFromPromotion(@PathVariable int promotion_id,  @RequestBody ProductReferenceSetDTO productReferenceSetDTO) throws NoDataFoundException, ServiceDownException {
    ...
    @ResponseStatus(HttpStatus.OK)
    @PreAuthorize("hasRole('ADMIN')")
    public void startPromotion(@PathVariable int promotion_id) throws NoDataFoundException, ServiceDownException {
    ...
    @ResponseStatus(HttpStatus.OK)
    @PreAuthorize("hasRole('ADMIN')")
    public void endPromotion(@PathVariable int promotion_id) throws NoDataFoundException, ServiceDownException {
