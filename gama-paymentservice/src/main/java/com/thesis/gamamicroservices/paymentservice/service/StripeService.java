...
public class StripeService {
    ...
    public StripeResponseDTO paymentIntent(PaymentOrderSetDTO paymentIntentDto) throws StripeException, NoDataFoundException, AlreadyPayedException {
        ...
        try {
            totalPrice = restTemplate.getForEntity(ORDER_SERVICE_URL + paymentIntentDto.getOrderID(), Double.class).getBody();
        ...
        if (payment.isEmpty() || payment.get().getState() != PaymentStatus.PAYED) {
            ...
            PaymentIntentCreateParams createParams = new PaymentIntentCreateParams.Builder()
                    ...
                    .setAmount((long) ((totalPrice) * 100L))
                    .setDescription(paymentIntentDto.getDescription())
                    .putMetadata("orderID", String.valueOf(paymentIntentDto.getOrderID()))
                    .build();
            ...
            paymentService.addPaymentToOrder(paymentIntentDto, totalPrice);
            ...
            throw new AlreadyPayedException("Order: " + paymentIntentDto.getOrderID() + " was already payed.");
        }
    }
    /**
